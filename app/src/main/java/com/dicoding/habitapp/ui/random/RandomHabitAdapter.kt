...
class RandomHabitAdapter(private val onClick: (Habit) -> Unit) : RecyclerView.Adapter<RandomHabitAdapter.PagerViewHolder>() {
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            when(pageType) {
                PageType.HIGH -> itemPriorityLevel.setImageResource(R.drawable.ic_priority_high)
                PageType.MEDIUM -> itemPriorityLevel.setImageResource(R.drawable.ic_priority_medium)
                PageType.LOW -> itemPriorityLevel.setImageResource(R.drawable.ic_priority_low)
            }
